...
def avvia_estrazione_calendario_veneto():
    print("--- 🚀 FASE 1: DOWNLOAD CALENDARIO VENETO (SCI DI FONDO) ---")
    
    # 🎯 IL NUMERO MAGICO: 190 è lo Sci di Fondo per il Veneto!
    params = {
        ...
        "idStagione": "2025", 
        "disciplina": "190", # Filtro infallibile dal server
...
def spider_atleti_master_con_tempo():
    ...
    # Leggiamo solo le gare del Veneto per estrema sicurezza
    ...
    for gara in lista_gare:
        ...
        print(f"\n🟢 Analizzo classifica: {nome_g} a {luogo_g} (Data: {data_g})")
