...
BASE_URL_AJAX = "https://coimport os
import requests
import time
import datetime
from bs4 import BeautifulSoup
...
def spider_atleti_master_con_tempo():
    ...
    for gara in lista_gare:
        ...
        # FIX: Protezione sicura contro gli errori di divisione dello slug
...
if __name__ == "__main__":
    ...
    spider_atleti_master_con_tempo()mitati.fisi.org/wp-admin/admin-ajax.php"
